#Crack By Dương Phú Quốc ( Và Những Nỗi Buồn )
#Buy Tools Crack Inbox Me
#Type File: spamsms.py
...
def bannerx():
  ...
  for h in ban:
    ...
    time.sleep(0.003)    
bannerx()
sdt = input("\033[1;32;40m» Nhập số điện thoại muốn spam : ")
...
if sdt == "0123456789":
  print("ĐỊT CON MẸ MÀY 0123...789 LÀ CON CẶC GÌ, CÚT")
  exit()
...
def run(sdt,i):
  ...
  print("\033[1;37;40m» \033[1;33;40mSPAM \033[1;31;40mTHÀNH CÔNG \033[1;32;40m| \033[1;37;40mSỐ LẦN :",i)
  for j in range(0,6):
    print(f"\033[1;37;40m</> \033[1;32;40mVui lòng chờ {5-j} giây\r",end="")
    time.sleep(1)
